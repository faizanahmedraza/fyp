                ...
                <ul class="ml-auto p-0 m-0 list-unstyled d-flex top-icon h-100">
                    <li class="dropdown user-profile align-self-center d-inline-block">
                        <a href="javascript:void(0)" class="nav-link py-0" data-toggle="dropdown" aria-expanded="false">
                            <div class="media">
                                <img src="/assets/images/user_profile/not_available.jpg" alt=""
                                     class="d-flex img-fluid rounded-circle" height="70" width="40">
                            </div>
                        </a>

                        <div class="dropdown-menu border dropdown-menu-right p-0">
                            <a class="dropdown-item px-2 text-danger align-self-center d-flex"
                               href="/student/manage-profile/"><span class="icon-user mr-2 h6  mb-0"></span> My
                                Profile</a>

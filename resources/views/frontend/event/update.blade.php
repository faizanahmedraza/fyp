                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/user/events" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="/user/events/{{$updateEvent->id}}/update"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control rounded"
                                                               ...
                                                               value="{{ old('location',$updateEvent->location) }}"
                                                               maxlength="50">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <textarea name="description" id="description" class="form-control"
                                                      ...
                                                      rows="3">{{ old('description',$updateEvent->description) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>

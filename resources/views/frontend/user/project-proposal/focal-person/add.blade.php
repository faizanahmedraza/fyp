                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/user/focal-person-research-proposals" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="/user/focal-person-add-research-proposal" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @if($errors->any())
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <a href="/user/focal-person-research-proposal-template"

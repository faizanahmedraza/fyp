                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/user/fyp-projects/add" class="btn btn-primary float-right">Add
                                        +</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @if(count($projects) > 0)
                                        @foreach($projects as $key => $project)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/user/fyp-projects/{{$project->id}}/detail"
                                                       class="btn btn-info btn-sm">Detail</a>
                                                    @if($project->status === 'pending')
                                                        <a href="/user/fyp-projects/{{$project->id}}/update"

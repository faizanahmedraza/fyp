                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Add Fyp Project</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="/user/fyp-projects" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="/user/fyp-projects/add" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @if($errors->any())

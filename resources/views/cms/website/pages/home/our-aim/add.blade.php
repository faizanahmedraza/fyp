                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Add Mission/Vision</h4>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('website.page.home.aim-intro.add.data') }}"
                                            ...
                                            <textarea name="vision" id="vision" class="form-control"
                                                      placeholder="Enter Description" rows="2">{{ old('vision') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <textarea name="mission" id="mission" class="form-control"
                                                      placeholder="Enter Description" rows="2">{{ old('mission') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <textarea name="values" id="values" class="form-control"
                                                      placeholder="Enter Description" rows="2">{{ old('values') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>

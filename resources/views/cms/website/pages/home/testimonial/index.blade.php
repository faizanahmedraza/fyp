                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Home Page Testimonial List</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{ route('website.page.home.testimonial.add') }}" class="btn btn-primary float-right">Add +</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
    ...
    <script>
        ...
        function deleteRecord(input, cmsTestimonialId) {
            ...
            swal({
                ...
                if (willDelete) {
                    axios.get(`/admin/website/pages/home/testimonial/delete/${cmsTestimonialId}`).then(function(response) {

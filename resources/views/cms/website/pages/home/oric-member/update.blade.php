                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Update ORIC Member</h4>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('website.page.home.oric-member.update.data',['cmsMemberId' => $updateMember->id]) }}"
                                            ...
                                            @if(!empty($updateMember->profile_picture))
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <div class="input-group">
                                                            <img src="{{ asset('assets/images/uploads/pages/'.$updateMember->profile_picture) }}"
                                                                 height="70" width="70">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <textarea name="description" id="description" class="form-control"
                                                      placeholder="Enter Description" rows="3">{{ old('description',$updateMember->description) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>

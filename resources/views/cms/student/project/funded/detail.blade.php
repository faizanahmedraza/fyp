                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Funded Project Detail</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="/admin/funded-projects" class="btn btn-primary float-right">←
                                        Back</a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           value="{{ \Carbon\Carbon::parse($project->submission_date)->format('d-m-Y') }}" readonly>
                                                </div>
                                            </div>

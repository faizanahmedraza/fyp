                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Update Research Project</h4>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="/admin/student/update-research-project/{{$project->id}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @if($errors->any())
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="cnic">This application is ?</label>
                                                    <br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" name="status"
                                                               id="status_approved"
                                                               class="custom-control-input"
                                                               value="approved" {{ old("status",$project->status) == 'approved' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" name="status"
                                                               id="status_rejected"
                                                               class="custom-control-input"
                                                               value="rejected" {{ old("status",$project->status) == 'rejected' ? 'checked' : '' }}>
                                                        <label class="custom-control-label checkbox-primary outline"

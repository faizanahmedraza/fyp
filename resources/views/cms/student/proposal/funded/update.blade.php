                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Update Funded Proposal</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="/admin/funded-proposals" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="/admin/funded-proposals/{{$proposal->id}}/update" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @if($errors->any())
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control rounded"
                                                           ...
                                                           value="{{ old('investigator_details_pi',$proposal->investigator_details_pi) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control rounded"
                                                           ...
                                                           value="{{ old('investigator_details_copi',$proposal->investigator_details_copi) }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="submission_date"
                                                           id="submission_date_id" value="{{ old('submission_date',\Carbon\Carbon::parse($proposal->submission_date)->format('d-m-Y')) }}"
...
@push('scripts')
    ...
    <script>
        oldSubmissionDate = '{{ old('submission_date',\Carbon\Carbon::parse($proposal->submission_date)->format('d-m-Y')) }}';
        $(function () {

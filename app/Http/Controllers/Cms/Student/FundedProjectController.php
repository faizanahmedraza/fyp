...
class FundedProjectController extends Controller
{
    ...
    {
        $this->middleware('permission:funded-project-list|funded-project-create|funded-project-update', ['only' => ['index', 'addProjectData']]);
        $this->middleware('permission:funded-project-create', ['only' => ['addProject', 'addProjectData']]);
        $this->middleware('permission:funded-project-update', ['only' => ['updateProject', 'updateProjectData']]);
    }
